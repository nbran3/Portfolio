General analyis and dashboard(s) of a dataset involving some sort of clothing store sales, which I found off Kaggle. Data was already cleaned. Pivot Tables, filtering, slicers, lookups were used.
